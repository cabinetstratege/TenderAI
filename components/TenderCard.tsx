      ...
      <div className="p-4 border-t border-border bg-slate-50/50 dark:bg-slate-900/30 space-y-3 relative z-10">
        ...
        <div className="flex gap-2">
          ...
          <button 
            ...
            className="flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-xl text-xs font-bold text-white bg-slate-900 dark:bg-blue-600 hover:bg-slate-800 dark:hover:bg-blue-500 shadow-md transition-all"
          >
