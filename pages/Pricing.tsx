  ...
  return (
    <div className="max-w-5xl mx-auto py-12 space-y-16">
      ...
      <div className="text-center space-y-8 animate-fade-in">
        ...
        <p className="text-slate-500 dark:text-slate-400 max-w-lg mx-auto">Accédez à toute la puissance de l'IA pour remporter vos marchés publics, sans engagement de durée.</p>
            ...
            <div className="p-8 bg-white dark:bg-slate-900">
                ...
                <button 
                    ...
                    className={`w-full mt-8 font-bold py-3 rounded-xl transition-all shadow-lg flex items-center justify-center gap-2 transform active:scale-95 duration-150 ${
                        ...
                        : 'bg-primary text-white hover:bg-blue-600 shadow-blue-500/20 dark:shadow-blue-900/20'
                    }`}
                >
                    {loading ? <Loader2 className="animate-spin" /> : (
                        isAlreadyActive ? <span className="flex items-center gap-2"><Check size={18}/> Abonnement Actif</span> : 'Commencer maintenant'
                    )}
                </button>
      ...
      <div className="space-y-8 pt-8 border-t border-slate-200 dark:border-slate-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <TestimonialCard 
                  name="Marc D."
                  role="Directeur BTP"
                  text="Grâce au score de compatibilité, nous ne perdons plus de temps à lire des DCE inutiles. J'ai gagné 2 marchés en 1 mois."
                  stars={5}
              />
              <TestimonialCard 
                  name="Sophie L."
      ...
      <div className="max-w-3xl mx-auto space-y-6 pt-8 border-t border-slate-200 dark:border-slate-800">
        ...
        <div className="space-y-4">
            <FAQItem 
                ...
                answer="Non, aucune ! Vous êtes libre d'arrêter votre abonnement à tout moment d'un simple clic depuis votre espace. Le mois en cours reste dû, mais aucun prélèvement suivant ne sera effectué." 
            />
            <FAQItem 
            ...
            <FAQItem 
                ...
                answer="Oui, absolument. Vous pouvez basculer entre France entière, Europe ou une sélection précise de départements à tout moment dans l'onglet Profil, sans surcoût." 
            />
             <FAQItem 
      ...
      <div className="bg-gradient-to-r from-slate-100 to-blue-50 dark:from-slate-900 dark:to-blue-950/30 rounded-2xl border border-slate-200 dark:border-slate-700 p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl">
          <div className="space-y-2 text-center md:text-left">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm max-w-md">
                  Notre équipe est basée en France et répond généralement sous quelques heures. N'hésitez pas à nous solliciter pour une démo ou une question technique.
              </p>
          </div>
          <a 
