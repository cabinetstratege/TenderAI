...
const SuperAdmin: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center bg-surface border border-slate-700 p-6 rounded-xl shadow-lg">
                <div>
                    <h1 className="text-2xl font-bold flex items-center gap-2 text-white">
                        <ShieldCheck className="text-emerald-400"/> SUPER ADMIN
                    </h1>
                    <p className="text-slate-400 text-sm">Contrôle total du SaaS</p>
                </div>
                ...
                <div className="lg:col-span-2 bg-surface rounded-xl shadow-lg border border-border overflow-hidden">
                    <div className="p-4 border-b border-border flex justify-between items-center">
                        ...
                        <div className="relative">
                            ...
                            <input 
                                ...
                                className="pl-8 pr-3 py-1 text-sm bg-background border border-slate-700 rounded-lg focus:outline-none focus:border-primary text-white"
                                value={searchTerm}
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm text-left">
                            <thead className="bg-slate-900 text-slate-400 font-medium border-b border-border">
                                <tr>
                            ...
                            <tbody className="divide-y divide-slate-800">
                                {filteredUsers.map(user => (
                                    <tr key={user.id} className="hover:bg-slate-800/50">
                                        ...
                                        <td className="px-4 py-3 truncate max-w-xs text-slate-400" title={user.specialization}>
                                            {user.specialization || "N/A"}
                                        </td>
                                        <td className="px-4 py-3">
                                            <span className="bg-slate-800 px-2 py-0.5 rounded text-xs text-slate-300 border border-slate-700">{user.scope}</span>
                                        </td>
                                        <td className="px-4 py-3">
                ...
                <div className="space-y-6">
                    <div className="bg-surface p-6 rounded-xl shadow-lg border border-border">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex justify-between items-center text-sm">
                                ...
                                <span className="text-slate-200 font-mono">v1.3.0</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-surface p-6 rounded-xl shadow-lg border border-border">
                        ...
                        <div className="space-y-2">
                            <button className="w-full py-2 bg-slate-800 text-slate-300 rounded-lg text-sm font-medium hover:bg-slate-700 border border-slate-700">
                                Vider le Cache Serveur
                            </button>
                            <button className="w-full py-2 bg-red-950/30 text-red-400 rounded-lg text-sm font-medium hover:bg-red-950/50 border border-red-900/50 flex justify-center items-center gap-2">
